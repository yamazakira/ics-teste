...
<body>
	...
	<div class="Post">
		...
		<a class="button" href="addFlor.php">Adicionar nova flor</a>
	</div>
				...
				echo '<tr>';
					...
					echo '<td>';
						echo '<div class="Post">';
							...
							echo '<a class="button" href="editFlor.php?id='.$row['id'].'">Editar</a>';
							echo '<a class="button" href="removeFlor.php?id='.$row['id'].'">Remover</a>';
						echo '</div>';
					echo '</td>';
				echo '</tr> ';
